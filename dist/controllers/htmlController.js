    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, utils_1.allHtmlFiles)(directory)];
            case 1:
                filesInOutput = _b.sent();
...
var getHtml = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var id, directory;
    return __generator(this, function (_a) {
        id = req.params.id;
        directory = path_1.default.join(__dirname, "../output" + "/".concat(id, ".html"));
